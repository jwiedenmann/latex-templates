...
\begin{titlepage}
	\begin{longtable}{p{8cm} p{6.5cm}}
		\raggedright {\raisebox{\ht\strutbox-\totalheight}{\includegraphics[height=1.5cm]{images/cover/logo-tha.pdf}}} &
		% no company logo for semester paper and special documents
		\ifDocType{T2\_3100}{}{%
			\ifSpecialDocument{}{%
				\raggedleft {\raisebox{\ht\strutbox-\totalheight}{\includegraphics[height=1.5cm]{images/cover/logo-company.png}}}
			}%
		}%
	\end{longtable}
